...
public:
	...
	FFlowDataPinResult BP_TrySupplyDataPin(const FName PinName) const;
	...
	FFlowDataPinResult BP_Super_TrySupplyDataPin(const FName PinName) const { return Super::TrySupplyDataPin(PinName); }
};
