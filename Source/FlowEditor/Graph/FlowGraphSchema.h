...
private:
	...
	void ConnectToSelectedNodes(UFlowNode* NewNodeclass, UEdGraph* ParentGraph) const;
};
...
public:
	...
	void TryConnectNodes(const TArray<UFlowNode*>& OutputNodes, UFlowNode* InputNode) const;
